...
def test_open_valve_closes_on_all_bad_sensor_readings() -> None:
    # Returns close valve
...
def test_open_valve_closes_on_moisture_avg_gt_close_above_percent() -> None:
    # Returns close valve
    pytest.skip("not implemented")


def test_open_valve_stays_open_when_no_close_trigger_fires() -> None:
    # Setup: valve is open, readings all good, moisture below close_above_percent,
    #        opened recently (< max_open_seconds ago)
    # Expected: valve remains open, TickResult.valve_is_open is True
    pytest.skip("not implemented")
